...
echo "<img src=images/".$arrayp['prodPicNameLarge']." height=400 width=450>";
...
/*to replace the text box in the form by a dynamically-populated drop-down list that will retrieve the stock level for this product from the
 database*/
